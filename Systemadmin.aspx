<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="Task.AdminUpdate" %>
...
<body background="2277.jpg">
    ...
    <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/Update.aspx" style="color:#990000" Font-Bold="False" CssClass="txtbox">Task Updation Sheet </asp:HyperLink>
                ...
                <asp:Panel ID="Panel1" runat="server" Style="width: 100%; height: 700px; overflow: scroll">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                        Font-Bold="False" DataKeyNames="id" Height="126px" OnPageIndexChanging="GridView1_PageIndexChanging"
                        OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting"
                        OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" PageSize="10" Width="99%"   CssClass ="auto-style1" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Task Completion Date">
                              ...
                              <asp:TemplateField HeaderText="Task Creation Date">
                                ...
                                <EditItemTemplate>
                                   <asp:TextBox ID="txtDate1" runat="server" TextMode="Date" Text='<%# Eval("TaskCreationDate","{0:yyyy-MM-dd}")%>' />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtDate1" ErrorMessage="*" ToolTip="कृपया पत्राची दिनांक टाका" ValidationGroup="gp1" ForeColor="White"></asp:RequiredFieldValidator>
                               </EditItemTemplate>
                            </asp:TemplateField>
